...
const BirdCanvas = () => {
    useEffect(() => {
        ...
        function init() {
            ...
            // gui.add(effectController, "separation", 0.0, 100.0, 1.0).onChange(
            //     valuesChanger
            // );
            // gui.add(effectController, "alignment", 0.0, 100, 0.001).onChange(
            //     valuesChanger
            // );
            // gui.add(effectController, "cohesion", 0.0, 100, 0.025).onChange(
            //     valuesChanger
            // );
            // gui.add(effectController, "size", 0, 1, 0.01).onChange(
            //     valuesChanger
            // );
            // gui.add(effectController, "count", 0, BIRDS, 1).onChange(
            //     valuesChanger
            // );
            // gui.close();
